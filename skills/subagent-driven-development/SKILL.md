...
- If the question depends on a proposed approach, trade-off, or design sketch, present that content in a visible assistant chat message first and ask via `question` only afterward
- Do not rely on `Thinking` or `question` justification text for decision-critical context
